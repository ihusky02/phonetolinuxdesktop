...
From now you can download a .deb file from  https://drive.google.com/file/d/10sup1_GX17QD7ToKqYIRILAKscH8B0L9/view?usp=sharing (because I don`t want play anymore with f***ng launchpad dependences). This is last package which you install mannually. On next version, you can use "Update" funcction in settings.
